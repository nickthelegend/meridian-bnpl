...
export default function MerchantDashboard() {
    const { address, authenticated, loading } = usePolaris();
    ...
    const generatePaymentQr = async () => {
        try {
            ...
            const protocol = `polaris://pay?merchant=${address}&amount=${amount}&token=${CONTRACTS.SOURCE.USDC}`;
                                    ...
                                    <div className="flex flex-col gap-8">
                                        ...
                                        <div className="flex flex-col gap-4 bg-primary/5 border border-primary/20 p-6 rounded-sm">
                                            ...
                                            <p className="text-[11px] text-white/50 leading-relaxed font-mono">
                                                By scanning this code, the customer authorizes a BNPL loan through Polaris Core. Funds are credited to your merchant balance immediately upon customer confirmation.
                                            </p>
                                        </div>
                                    </div>
