...
async function main() {
    ...
    let allDeployments = {};
    const spokePath = path.join(__dirname, '../../polaris-protocol/spoke_deployments.json');
    const extraPath = path.join(__dirname, '../../polaris-protocol/extra_tokens_sepolia.json');
